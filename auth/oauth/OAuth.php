...
log_error("##############FETCH-TOKEN");
  ...
  private function check_signature(&$request, $consumer, $token) {/*{{{*/
    ...
    $built = $signature_method->build_signature(
      ...
      log_error("BUILD SIGNATURE: $built");
      log_error("YOUR SIGNATURE: $signature");
    if ($signature != $built) {
